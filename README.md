...
With this idea in place, you will not be hassled deploying new kubernetes resources, when a new function is deployed.   
The best use case will be a monitoring system that runs periodically, detecting abnormalies from system and trigger alerts. 
